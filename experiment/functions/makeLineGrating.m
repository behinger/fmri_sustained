function grating = makeLineGrating(contrast,stimSize,inner_rad,spatialFrequency,lumPol,barWidth,phase,distFromScreen, pix_per_cm,environment,scanner,whichScreen)
