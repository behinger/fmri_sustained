function gaborPatch = makeGaborStimulus(contrastGrating,sizeGrating,phaseGrating,spatialFrequency,annulus,distFromScreen,environment,scanner,whichScreen)
