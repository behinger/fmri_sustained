function plaid = makeLinePlaid(contrast,stimSize,inner_rad,spatialFrequency,lumPol,HbarWidth,Hphase,VbarWidth,Vphase,distFromScreen,environment,scanner,whichScreen)
...
% space)
HbarWidth = degrees2pixels(HbarWidth, distFromScreen, [], whichScreen);
HinterBar = round((stimSize/nCycles)-HbarWidth); % Space between bars

VbarWidth = degrees2pixels(VbarWidth, distFromScreen, [], whichScreen);
