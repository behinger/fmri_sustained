function grating = makeBRGrating(blackBackground, colour, contrast, stimSize, inner_rad, spatialFrequency, barWidth, phase, distFromScreen, environment, scanner, whichScreen)
