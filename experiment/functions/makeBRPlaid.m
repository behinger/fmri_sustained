function plaid = makeBRPlaid(blackBackground, redContrast, greenContrast, stimSize, inner_rad, spatialFrequency, barWidth, redPhase, greenPhase, distFromScreen, pix_per_cm, environment, scanner, whichScreen)
