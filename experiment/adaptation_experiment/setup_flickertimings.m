function trialFlicker = setup_flickertimings(params,ntrial,flickertimeOneTrial)
assert(all(isfield(params,{'flickerPerTrial','flickerTimeDelta'})))
totalFlicker = floor(params.flickerPerTrial * ntrial);
minDist = params.flickerTimeDelta;
